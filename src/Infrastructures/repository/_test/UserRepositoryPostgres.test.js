...
describe('UserRepositoryPostgres', () => {
  ...
  describe('verifyUserAvailability function', () => {
    it('should throw NotFoundError when a user not found', async () => {
      // Arrange
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});

      // Action & Assert
      await expect(userRepositoryPostgres.verifyUserAvailability('user-234')).rejects.toThrowError(NotFoundError);
    });

    it('should not throw NotFoundError when a user is found', async () => {
      // Arrange
